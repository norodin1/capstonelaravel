...
<header>
    ...
    >
      ...
      >
        ...
        <form action="{{route('search')}}" method="GET" class="flex items-center order-last md:order-2 md:w-3/5">
        ...
        >
        @if ((request()->routeIs('admin.*') && auth()->check())  || !request()->routeIs('admin.*'))
        <div
